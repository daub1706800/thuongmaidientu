	...
	class ni_custom_order_status_init {
		...
		function ni_display_custom_order_status_meta_box($order_status)
		{
			...
			<table class="status_fields">
				<tr>
					<th><label for="_ni_order_status_slug" class="ni-order-status-slug"><?php esc_html_e( 'Order Status Slug', 'niwoocos' )?></label></th>
					<td><input type="text" size="30" name="_ni_order_status_slug" id="_ni_order_status_slug" value="<?php echo sanitize_key($order_status_slug); ?>" maxlength="18"  /></td>
				</tr>
				<tr>
					<th><label for="_ni_order_status_color" class="prfx-row-title"><?php esc_html_e( 'Color Picker', 'niwoocos' )?></label></th>
					<td><input name="_ni_order_status_color" type="text" value="<?php echo sanitize_hex_color(isset($order_status_color)?$order_status_color: "#ffffff"); ?>"  id="_ni_order_status_color" class="order_status_color" /></td>
				</tr>
                <tr>
					<th><label for="_ni_order_status_description" class="ni-order-status-description"><?php esc_html_e( 'Description', 'niwoocos' )?></label></th>
					<td><textarea name="_ni_order_status_description" id="_ni_order_status_description" rows="6" cols="15"><?php echo sanitize_textarea_field($order_status_description);?></textarea></td>
				</tr>
			</table>
			<?php
		}
