        ...
        <div class="container-fluid" id="niwoocos">
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php print($this->get_customer()); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php print($this->get_customer(date_i18n("Y-m-d"),date_i18n("Y-m-d"))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php print($this->get_guest_customer()); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php print($this->get_guest_customer(date_i18n("Y-m-d"),date_i18n("Y-m-d"))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php print($this->get_sold_product_count( date_i18n("Y-m-d"), date_i18n("Y-m-d"))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                    	 ...
                    	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                        	<tr>
                                ...
                                <th class="text-right"><?php esc_html_e( 'Order Total', 'niwoocos'); ?>  </th>
                            </tr>
                        </thead>
            ...
            <div class="row" >
            	<div class="col-md-12" >
                    ...
                    <script type="text/javascript">
	                     var order_status_data  =  <?php echo  json_encode ($data )?>;					
                    </script>
            ...
            <div class="row" >
            	<div class="col-md-12" >
                      ...
                      <div class="card-body "> 
                        <div class="row">
                            ...
                            <div class="table-responsive niwoocos-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php esc_html_e( 'Payment Method', 'niwoocos'); ?> </th>
                                <th><?php esc_html_e( 'Order Count', 'niwoocos'); ?></th>
                                <th><?php esc_html_e( 'Order Total', 'niwoocos'); ?></th>
                            </tr>
                            </thead>
					...
					?>
                    <script type="text/javascript">
                    	var payment_gateway_pie_chart_data  =  <?php echo  json_encode ($data )?>;					
                    </script>
