    ...
    */
    ...
    private function widget_fields() {        
        ...
        $fields = array( 
            ...
            'buzzstore_about_title' => array(
                'buzzstore_widgets_name' => 'buzzstore_about_title',
                'buzzstore_widgets_title' => esc_html__( 'Heading', 'buzzstore' ),
                'buzzstore_widgets_field_type' => 'text',
            ),

            'buzzstore_about_ptitle' => array(
                'buzzstore_widgets_name' => 'buzzstore_about_ptitle',
    ...
    public function widget($args, $instance) {
        ...
        $buzzstore_about_title  = empty( $instance['buzzstore_about_title'] ) ? '' : $instance['buzzstore_about_title'];
        $buzzstore_about_ptitle  = empty( $instance['buzzstore_about_ptitle'] ) ? '' : $instance['buzzstore_about_ptitle'];
    ...
    ?>
      <div class="about-container buzz-clearfix">
            ...
            <?php  if (!empty($buzzstore_about_title)) { ?>
                <h2 class="widget-title"><?php echo esc_html($buzzstore_about_title); ?></h2>
            <?php } ?>            
            ...
            <?php if(!empty( $logo )) { ?>
                ...
                <?php  if (!empty($buzzstore_about_ptitle)) { ?>
                    <h3 class="buzz_about_title"><?php echo esc_html($buzzstore_about_ptitle); ?></h3>
                <?php } ?>            
        
            <?php }  if(!empty( $shor_desc )) { ?>
                <span class="about-small-text">
                    <?php echo esc_html( $shor_desc ); ?>
                </span>
            <?php } ?>       
