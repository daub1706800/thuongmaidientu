      ...
      **/
      ...
      private function widget_fields() {          
          ...
          $fields = array( 
              ...
              'buzzstore_product_cols_no' => array(
                  'buzzstore_widgets_name' => 'buzzstore_product_cols_no',
                  'buzzstore_widgets_title' => esc_html__('Select Number of Columns', 'buzzstore'),
                  'buzzstore_widgets_field_type' => 'select',
                  'buzzstore_widgets_field_options' => array(
                    '1' => esc_html__('1', 'buzzstore'),
                    '2' => esc_html__('2', 'buzzstore'),
                    '3' => esc_html__('3', 'buzzstore'),
                    '4' => esc_html__('4', 'buzzstore'),
                  ),
              ),
      ...
      public function widget($args, $instance) {
          ...
          */  
          ...
          $product_number   = intval( empty( $instance['buzzstore_product_number'] ) ? '' : $instance['buzzstore_product_number'] );
          $product_cols_no = empty( $instance['buzzstore_product_cols_no'] ) ? '' : $instance['buzzstore_product_cols_no'];
        ...
        */
        ...
        private function widget_fields() {
            ...
            $fields = array( 
                ...
                'buzzstore_cat_coll_columns_no' => array(
                    'buzzstore_widgets_name' => 'buzzstore_cat_coll_columns_no',
                    'buzzstore_widgets_title' => esc_html__('Select Number of Columns', 'buzzstore'),
                    'buzzstore_widgets_field_type' => 'select',
                    'buzzstore_widgets_field_options' => array(
                        '1' => __('1', 'buzzstore'),
        ...
        public function widget($args, $instance) {
            ...
            */  
            ...
            $buzzstore_cat_coll_columns_no  = empty( $instance['buzzstore_cat_coll_columns_no'] ) ? '' : $instance['buzzstore_cat_coll_columns_no'];
        ...
        <section id="slider" class="slider-container home-section">
          <div class="buzz-container buzz-clearfix relative">                    
            ...
            <div class="starSeparatorBox">                  
              ...
              <div id="owl-product-slider" class="enable-owl-carousel owl-product-slider wow fadeInUp" data-wow-delay="0.7s" data-navigation="true" data-pagination="false" data-single-item="false" data-auto-play="false" data-transition-style="false" data-main-text-animation="false" data-min600="2" data-min800="3" data-min1200="<?php echo intval($buzzstore_cat_coll_columns_no); ?>">
                <?php
                    $count = 0; 
                    ...
                    <div class="product-item">                        
                        <a href="<?php echo esc_url( $term_link ); ?>">
                            ...
                            <ul class="buzz-categorycount transition">
                                ...
                                <p class="buzz-productcount"><?php echo esc_html( $sub_count );  ?></p>                    
                            </ul>
                        </a>
                    </div>
                </div>
