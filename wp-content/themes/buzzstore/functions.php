...
function buzzstore_scripts() {
	    ...
	    wp_enqueue_script('buzzstore-custom', get_template_directory_uri() . '/assets/js/buzzstore-custom.js', array('jquery','imagesloaded'), $theme_version, 'ture');
...
function buzzstore_widget_theme_support() {
    remove_theme_support( 'widgets-block-editor' );
}
add_action( 'after_setup_theme', 'buzzstore_widget_theme_support' );