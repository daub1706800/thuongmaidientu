...
$blog_view_mode = get_theme_mod( 'buzz_blog_view_mode', 'buzzstore' );

?>
<article id="post-<?php the_ID(); ?>" <?php post_class("wow fadeInUp $blog_view_mode"); ?> data-wow-delay="0.3s" itemtype="http://schema.org/BlogPosting" itemtype="http://schema.org/BlogPosting">						
