    ...
    <div class="welcome-demo-import">
        <div class="welcome-demo-importin">
            ...
            <div class="welcome-demo-import-text">
                ...
                <a class="button button-primary" href="https://mysticalthemes.com/theme/meta-store/" target="_blank"><?php echo esc_html__('View Available Demos', 'meta-store'); ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="welcome-upgrade-wrap">
    ...
    <div class="upgrade-demo-wrap">
        ...
        <div class="recommend-plugins">
            <div class="plug-image">
                <img src="http://mysticalthemes.com/import/meta-store/screen/cosmetics-plus-screenshot.png" alt="<?php echo esc_attr__('Meta Store Demos', 'meta-store'); ?>">
            </div>
