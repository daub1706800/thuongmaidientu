...
$wp_customize->add_panel('metrostore_general_settings', array(
   ...
   'title' => esc_html__('General Settings', 'metrostore')
    ...
    $wp_customize->register_section_type('MetroStore_Customize_Upgrade_Section');
  ...
  'priority' => 21,
	...
	*/
    $wp_customize->add_section('metrostore_header_service_area', array(
		...
		$wp_customize->add_setting('metrostore_header_service_area_upgrade_text', array(
	        'sanitize_callback' => 'metrostore_text_sanitize'
	    ));

	    $wp_customize->add_control(new MetroStore_Upgrade_Text($wp_customize, 'metrostore_header_service_area_upgrade_text', array(
	        'section' => 'metrostore_header_service_area',
	        'label' => esc_html__('For more settings,', 'metrostore'),
	        'choices' => array(
	            esc_html__('Option to select Font Awesome Icon', 'metrostore'),
	        ),
	        'priority' => 100
	    )));

	    $wp_customize->add_section(new MetroStore_Customize_Upgrade_Section($wp_customize, 'metrostore_header_upgrade_section', array(
	        'title' => esc_html__('More Sections on Premium', 'metrostore'),
	        'panel' => 'metorstore_header_settings',
	        'priority' => 1000,
	        'options' => array(
	            esc_html__('- General Header Settings', 'metrostore'),
	            esc_html__('- Main Menu Settings', 'metrostore'),
	            esc_html__('- Header Type Settings', 'metrostore'),
	            esc_html__('- Top Header Settings', 'metrostore'),
	            esc_html__('------------------------', 'metrostore'),
	            esc_html__('- Elementor Pagebuilder Compatible. All the above sections can be created with Elementor Page Builder or Customizer whichever you like.', 'metrostore'),
	        )
	    )));
...
$wp_customize->add_section('metrostore_breadcrumbs_section', array(
  ...
  'priority' => 23,
	...
	$wp_customize->add_setting('metrostore_breadcrumbs_section_upgrade_text', array(
        'sanitize_callback' => 'metrostore_text_sanitize'
    ));

    $wp_customize->add_control(new MetroStore_Upgrade_Text($wp_customize, 'metrostore_breadcrumbs_section_upgrade_text', array(
        'section' => 'metrostore_breadcrumbs_section',
        'label' => esc_html__('For more sections, settings and controls,', 'metrostore'),
        'choices' => array(
            esc_html__('Enable/Disable Breadcrumbs Menu', 'metrostore'),
            esc_html__('Seperate Woocommerce Breadcrumbs Section', 'metrostore'),
        ),
        'priority' => 100
    )));
...
$wp_customize->add_section('metrostore_main_banner_area', array(
  ...
  'priority' => 24,
	...
	$wp_customize->add_setting('metrostore_main_banner_area_upgrade_text', array(
        'sanitize_callback' => 'metrostore_text_sanitize'
    ));

    $wp_customize->add_control(new MetroStore_Upgrade_Text($wp_customize, 'metrostore_main_banner_area_upgrade_text', array(
        'section' => 'metrostore_main_banner_area',
        'label' => esc_html__('For more slider types, layouts and settings,', 'metrostore'),
        'choices' => array(
            esc_html__('Select from different types of slider', 'metrostore'),
            esc_html__('Supports Revolution Slider', 'metrostore'),
            esc_html__('Add Unlimited Slider', 'metrostore'),
            esc_html__('Customize Slider Image, Title, Short Description, Button Text and Url', 'metrostore'),
            esc_html__('Select from various slider layout options', 'metrostore'),
        ),
        'priority' => 100
    )));
	...
	*/
    $wp_customize->add_section('metrostore_copyright_message', array(
		...
		$wp_customize->add_setting('metrostore_footer_copyright_setting', array(
      	...
      	$wp_customize->add_section(new MetroStore_Customize_Upgrade_Section($wp_customize, 'metorstore_settings_upgrade_section', array(
	        'title' => esc_html__('More Sections on Premium', 'metrostore'),
	        'panel' => 'metorstore_settings',
	        'priority' => 1000,
	        'options' => array(
	            esc_html__('- Footer General Settings', 'metrostore'),
	            esc_html__('- Footer Right Side Settings', 'metrostore'),
	            esc_html__('- Payment Logo Images Section', 'metrostore'),
	            esc_html__('------------------------', 'metrostore'),
	            esc_html__('- Elementor Pagebuilder Compatible. All the above sections can be created with Elementor Page Builder or Customizer whichever you like.', 'metrostore'),
	        )
	    )));
