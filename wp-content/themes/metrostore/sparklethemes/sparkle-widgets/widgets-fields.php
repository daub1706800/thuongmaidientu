        ...
        **/
        case 'multicheckcategory' :
            ...
            if( isset( $metrostore_mulicheckbox_title ) ) { ?>
                <label><?php echo esc_html( $metrostore_mulicheckbox_title ); ?> :</label>
            <?php }
            echo '<div class="metrostore-multiplecat">';
                ...
                ?>
                    <p>
                        <input id="<?php echo esc_attr($instance->get_field_id($metrostore_widgets_name)); ?>" name="<?php echo $instance->get_field_name($metrostore_widgets_name).'['.$metrostore_option_name.']'; ?>" type="checkbox" value="1" <?php checked('1', $metrostore_field_value[$metrostore_option_name]); ?>/>
                        <label for="<?php echo esc_attr($instance->get_field_id($metrostore_option_name)); ?>"><?php echo $metrostore_option_title; ?></label>
                    </p>
                <?php
                    }
            echo '</div>';
