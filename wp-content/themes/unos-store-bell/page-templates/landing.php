...
add_filter( 'unos_layout', 'unosbell_layout' );
function unosbell_layout( $sidebar ){
	return apply_filters( 'unosbell_layout', 'full-width', $sidebar );
}
...
<body <?php hoot_attr( 'body' ); ?>>
	...
	<a href="#main" class="screen-reader-text"><?php esc_html_e( 'Skip to content', 'unos-store-bell' ); ?></a>
