<?php
/**
 * Adds buzzstore_lite_blog_widget widget.
 */
add_action('widgets_init', 'buzzstore_lite_blog_widget');

function buzzstore_lite_blog_widget() {
    register_widget('buzzstore_lite_blog_widget_area');
}

class buzzstore_lite_blog_widget_area extends WP_Widget {
    ...
    */
    public function __construct() {
        parent::__construct(
                'buzzstore_lite_blog_widget_area', esc_html__('&nbsp;Buzz: Blogs Widget 2','buzzstore-lite'), array(
            'description' => esc_html__('A widget that display latest three posts', 'buzzstore-lite')
        ));
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            'buzzstore_blogs_title' => array(
                ...
                'buzzstore_widgets_title' => esc_html__('Blogs Title', 'buzzstore-lite'),
            ...
            'blogs_posts_display_order' => array(
                ...
                'buzzstore_widgets_title' => esc_html__('Display Posts Order', 'buzzstore-lite'),
                'buzzstore_widgets_field_type' => 'select',
                'buzzstore_widgets_field_options' => array(
                    'ASC' => esc_html__('Ascending Order','buzzstore-lite'),
                    'DESC' => esc_html__('Descending Order', 'buzzstore-lite')
                )
            ),
        );
    ...
    public function widget($args, $instance) {
        ...
        */
        ...
        <section id="fromBlog" class="buzz-container home-section buzz-clearfix">
            ...
            <div class="blog-container widget_buzzstore_blog_widget_area layout2 starSeparatorBox">

                <div class="starSeparator wow zoomIn" data-wow-delay="0.3s">
                    <span class="icon-star" aria-hidden="true"></span>
                </div>

                <ul class="buzzstore-blogwrap buzz-clearfix">
                            ...
                            <div class="blog-preview wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <div class="content-wrap">             
                                    ...
                                    <a class="btn-readmore" href="<?php the_permalink(); ?>">
                                        <?php esc_html_e('Read More', 'buzzstore'); ?>
                                    </a>
                                </div>
                            </div>
                        </li>
