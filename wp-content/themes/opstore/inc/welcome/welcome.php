	...
	if(!class_exists('Opstore_Welcome')) :
		...
		class Opstore_Welcome {
			...
			public function welcome_admin_notice_display(){
                ?>
			<div class="notice notice-success is-dismissible operation-theme-welcome-info">
			<p>
			<?php
			...
			<p><a class="button button-primary" href="<?php echo esc_url(admin_url( 'themes.php?page=welcome-page' )) ?>"><?php esc_html_e( 'Lets Get Started', 'opstore' ); ?></a>
				<span class="dismiss"><a href="?theme-info-ignore-notice"><?php esc_html_e('Dismiss','opstore') ?></a></span>
			</p>
			</div>
			<?php
