...
class Shopix_Repeater_Control extends WP_Customize_Control {
		
	/**
	 * The type of control being rendered
	 */
	public $type = 'shopix-sortable_repeater';
	/**
	 * Button labels
	 */
	...
	?>
		<div class="shopix-sortable_repeater_control">
			...
			<div class="shopix-sortable_repeater sortable">
				<div class="repeater">
