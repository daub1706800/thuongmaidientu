...
add_action( 'woocommerce_single_product_summary', 'vantheweb_product_sold_count', 11 );
  
function vantheweb_product_sold_count() {
   global $product;
   $units_sold = $product->get_total_sales();
   if ( $units_sold ) echo '<div class ="woo-vantheweb">' . sprintf( __( '<i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Đã bán: %s', 'woocommerce' ), $units_sold ) . '</div>';
}
